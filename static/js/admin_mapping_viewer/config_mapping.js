...
export let APP_CONFIG = {
    ...
    URL_FOR_ADMIN_SCREEN_ELEMENTS: '', // Sẽ được ghi đè từ pageConfig
    API_BASE_URLS: {
    ...
    DOM_ELEMENT_IDS: {
        ...
        editTransitionActionTypeSelect: 'editTransitionActionTypeSelect',
        editTransitionElementIdInput: 'editTransitionElementIdInput',
        editTransitionIdentifierTypeInput: 'editTransitionIdentifierTypeInput',
        editTransitionElementTextInput: 'editTransitionElementTextInput',
        editTransitionMacroCodeInput: 'editTransitionMacroCodeInput',
        editTransitionParamsJsonTextarea: 'editTransitionParamsJsonTextarea',
        editTransitionStatusSelect: 'editTransitionStatusSelect',
        editTransitionAttemptCountInput: 'editTransitionAttemptCountInput',
        editTransitionSuccessCountInput: 'editTransitionSuccessCountInput'
    },
