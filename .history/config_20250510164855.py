...
class Config:
    ...
    # --- Cấu hình SQLAlchemy ---
    UPLOAD_FOLDER = os.path.join(basedir, 'app', 'static', 'screenshots')

    MAX_CONTENT_LENGTH = 16 * 1024 * 1024 
    ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg'}
    BASE_DIR = os.path.abspath(os.path.dirname(__file__))
    SCREENSHOT_STORAGE_PATH = os.path.join(BASE_DIR, 'app_screenshots')
    FLASK_STATIC_FOLDER = os.path.join(BASE_DIR, 'app', 'static') # Ví dụ nếu bạn có biến này
    SCREENSHOT_FOLDER = os.path.join(FLASK_STATIC_FOLDER, 'screenshots')
    SCREENSHOT_URL_BASE = '/static/screenshots'
