...
export function initializeAppConfig(pageConfig) {
    ...
    if (!pageConfig) {
        ...
        console.log("CONFIG_MAPPING: Default APP_CONFIG.DOM_ELEMENT_IDS.editTransitionModal:", APP_CONFIG.DOM_ELEMENT_IDS.editTransitionModal);
        return;
    }
    ...
    if (pageConfig.apiBaseUrls) {
        // Log giá trị từ pageConfig trước khi merge
    ...
    // Log cụ thể các giá trị quan trọng
