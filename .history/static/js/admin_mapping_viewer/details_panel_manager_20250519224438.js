...
function getDetailsPanelDOMElements() {
    ...
    panelTextContentDiv = document.getElementById(IDS.panelTextContent);
    panelActionsAreaDiv = document.getElementById(IDS.panelActionsArea);
    panelScreenshotAreaDiv = document.getElementById(IDS.panelScreenshotArea);
    panelScreenshotContainer = document.getElementById(IDS.panelScreenshotContainer);
    panelScreenshotImage = document.getElementById(IDS.panelScreenshotImage);
}
...
export function initDetailsPanelManager() {
    ...
    if (!panelTextContentDiv || !panelActionsAreaDiv || !panelScreenshotAreaDiv || !panelScreenshotContainer || !panelScreenshotImage) {
        console.error("DETAILS_PANEL: Một hoặc nhiều DOM elements của panel chi tiết không tìm thấy.");
    }
