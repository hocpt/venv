...
export function initTableHandler() {
    ...
    function renderNodeRow(node) {
        ...
        if (node.screenshot_full_url) { // LUÔN KIỂM TRA BIẾN NÀY
            imgHtml = `<img src="<span class="math-inline">\{node\.screenshot\_full\_url\}" alt\="ss\_</span>{node.screen_id}" class="node-thumbnail ${APP_CONFIG.CSS_CLASSES.MANAGE_PIE_TRIGGER}" title="Quản lý PIE Conditions">`;
        }
