...
def handle_explore_step(current_screen_id_from_client: str | None, # ID client gửi lên
                        raw_ui_state: dict,
                        previous_action: dict | None,
                        account_id: str, # <<< THIẾU device_id ở đây
                        **kwargs
                       ) -> tuple[dict, int]:
    ...
    try:
        ...
        active_task = db.get_active_task_for_device(device_id) # Ví dụ
