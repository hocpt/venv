...
def handle_explore_step(device_id: str, account_id: str,
                        ...
                        screenshot_filename: str | None = None, # <<< Đổi tên tham số thành screenshot_filename
    ...
    try:
        ...
        if screenshot_filename:
            logger.info(f"Sẽ sử dụng screenshot filename: '{screenshot_filename}' để lưu vào Neo4j.")
