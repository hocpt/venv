...
def handle_explore_step(device_id: str, account_id: str,
    ...
    try:
        ...
        logger.debug("[Explore Step Ctrl] Logging to PostgreSQL...")
        try:
            ...
            if db and hasattr(db, 'add_phone_action_logs'):
                 ...
                 logger.debug("[Explore Step Ctrl] PostgreSQL logging successful (or no data to log).")
            else:
                 logger.warning("[Explore Step Ctrl] PostgreSQL logging skipped: DB module or function unavailable.")
        except Exception as pg_log_err:
             # Ghi log lỗi nhưng không dừng hẳn luồng chính
