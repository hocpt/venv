...
try:
    ...
    from .utils import determine_screen_id_from_state, process_raw_ui_state, _parse_coordinates_safe,determine_screen_id_by_defined_pie
    ...
    # from ..utils import determine_screen_id_from_state, process_raw_ui_state, _parse_coordinates_safe
     ...
     def determine_screen_id_by_defined_pie(*args, **kwargs): return None
...
def handle_explore_step(device_id: str, account_id: str,
    ...
    logger.debug(f"[Explore Step Ctrl] Raw UI State from client: {json.dumps(raw_ui_state, indent=2, ensure_ascii=False)}")
    # ===============================================================
