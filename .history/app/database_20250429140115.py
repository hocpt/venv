...
def add_phone_action_logs(assignment_id: int, device_id: str, account_id: str,
    ...
    logger.debug(f"Inside add_phone_action_logs)
    ...
    try:
        ...
        for log_entry in logs:
            ...
            logger.debug(f"Inside add_phone_action_logs - received structured_ui_state_json (type: {type(structured_ui_state_json)}): {str(structured_ui_state_json)[:500]}...")
