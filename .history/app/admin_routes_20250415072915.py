...
def view_rules():
    ...
    distinct_categories = [] # Cho dropdown filter
    distinct_template_refs = [] # Cho dropdown filter
    active_filters = {} # Filter đang dùng
    ...
    if not db:
        ...
        try:
            ...
            if rules: # Chỉ chạy nếu có rules
    ...
    return render_template('admin_rules.html',
                           ...
                           distinct_categories=distinct_categories,      # <<< Mới
                           distinct_template_refs=distinct_template_refs, # <<< Mới
