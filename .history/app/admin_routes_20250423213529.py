...
def add_strategy():
    ...
    if request.method == 'POST':
        ...
        if  not name or not strategy_type_resolved:
            errors.append("Strategy ID, Name, và Strategy Type (ẩn) là bắt buộc2.") # Thông báo lỗi này KHÔNG bao gồm Initial Stage ID
