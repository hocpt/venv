...
def add_scheduled_job():
    ...
    available_tasks = [
        ('Chạy Engine Đề xuất (Suggestion Engine)', 'app.background_tasks:run_suggestion_engine_task'),
        ('Chạy Mô phỏng Hội thoại (Simulation)', 'app.background_tasks:run_simulation_task'),
        # Thêm các hàm tác vụ nền khác của bạn vào đây
        # ('Tên hiển thị khác', 'app.module_khac:ham_khac')
    ]
