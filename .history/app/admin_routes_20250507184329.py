    ...
    try:
        ...
        if path_from_neo4j:
            try:
                ...
                # filename phải là đường dẫn tương đối TỪ thư mục static
                # Ví dụ: nếu path_from_neo4j là "screenshots/abc.png"
                # và static_folder là "app/static", thì Flask sẽ tìm "app/static/screenshots/abc.png"
                screenshot_url = url_for('static', filename=path_from_neo4j)
                logger.info(f"[admin_screen_elements] Đã tạo URL screenshot bằng 'static': '{screenshot_url}'")
        ...
        if detailed_ui_state and isinstance(detailed_ui_state.get('elements'), list):
            ...
            if saved_data is None: saved_data = {}
