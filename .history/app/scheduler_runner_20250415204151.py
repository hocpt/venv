...
try:
    ...
    print("DEBUG (scheduler_runner): Relative imports successful.")
    # Đặt flag hoặc kiểm tra db sau này nếu cần
    _imports_successful = True
except ImportError as e:
    print(f"CRITICAL ERROR (scheduler_runner): Failed to import dependencies via relative path: {e}.")
    print("Check project structure, __init__.py files, and potential errors within imported modules (database.py, background_tasks.py).")
        ...
        for command in all_pending:
            ...
            try:
                ...
                # --- LỆNH CHẠY MÔ PHỎNG ---
                    ...
                    job_name_display = f"Sim Cmd {command_id}: {persona_a_id} vs {persona_b_id} ({strategy_id})"
