...
def create_app(config_class=config.Config):
    ...
    def serve_screenshot_for_app(filename): # Tên hàm này sẽ là tên endpoint
        logger = app.logger # Hoặc app.logger nếu app được truyền vào
        ...
        logger.info(f"[Serve Screenshot] Request for App: '{app}', File: '{filename}'")
        ...
        app_specific_screenshot_dir = os.path.join(screenshots_base_dir, app)
