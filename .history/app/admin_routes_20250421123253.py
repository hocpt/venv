...
def cancel_task_assignment(assignment_id):
    ...
    try:
        ...
        success, error_msg = db.update_assignment_status(
            assignment_id=assignment_id,
            new_status='cancelled',
            completed_at=datetime.now(timezone.utc), # Đặt thời gian hoàn thành khi hủy
            # result_data={'reason': 'Cancelled by admin'} # Có thể thêm lý do hủy
        )
