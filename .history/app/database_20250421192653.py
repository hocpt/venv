...
def add_new_transition(strategy_id: str, current_stage_id: str, user_intent: str,
    ...
    try:
        ...
        sql = """
            INSERT INTO public.stage_transitions (
                strategy_id,current_stage_id, user_intent, condition_type, condition_value,
            ...
            ) VALUES (%s,%s, %s, %s, %s, %s, %s, %s::jsonb, %s, %s, %s, %s, %s, %s::jsonb, %s); -- Ép kiểu JSONB
        """
        params = (
            strategy_id,current_stage_id, user_intent,
