...
def add_strategy():
    ...
    if request.method == 'POST':
        ...
        # === PHẦN VALIDATION QUAN TRỌNG ===
        errors = []
        # *** DÒNG KIỂM TRA ĐÃ SỬA: KHÔNG còn 'initial_stage_id' ở đây ***
        if not strategy_id or not name or not strategy_type_resolved:
            # Thông báo lỗi này KHÔNG được bao gồm "Initial Stage ID"
        ...
        # === KẾT THÚC PHẦN VALIDATION QUAN TRỌNG ===
