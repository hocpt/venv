...
def update_task_mapping_status(assignment_id: int, new_status: str) -> tuple[bool, str | None]:
    ...
    success = False
    error_msg = None
    # <<< SỬA LỖI SQL: Cần dấu phẩy giữa các SET assignments >>>
    sql = "UPDATE task_assignments SET mapping_status = %s, updated_at = NOW() WHERE assignment_id = %s;" # Thêm updated_at
