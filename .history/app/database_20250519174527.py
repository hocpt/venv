...
def create_new_pie_definition_from_node(
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            sql = """
                INSERT INTO screen_definitions 
        (app_name, activity_name, logical_screen_name, defined_screen_id, identifying_elements, description, created_at, updated_at) 
    VALUES (%s, %s, %s, %s, %s, %s, NOW(), NOW()) RETURNING definition_id; 
                RETURNING id; 
            """
