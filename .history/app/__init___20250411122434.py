...
def create_app(config_class=config.Config):
    ...
    # <<< THÊM DÒNG NÀY ĐỂ GẮN SCHEDULER THỦ CÔNG VÀO APP >>>
    if not hasattr(app, 'scheduler'):
        print("DEBUG: Manually attaching scheduler to app object as app.scheduler")
        app.scheduler = scheduler
    # <<< KẾT THÚC DÒNG THÊM >>>

    # --- Bắt đầu scheduler và load jobs (giữ lại if check) ---
