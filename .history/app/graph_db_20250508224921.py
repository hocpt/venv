...
Ok, đây là phiên bản đầy đủ của hàm merge_screen trong app/graph_db.py, được cập nhật để nhận và lưu trữ thêm screen_width và screen_height vào node :Screen trong Neo4j.

Python

# Thêm vào file app/graph_db.py

# ... (các imports và hàm khác như get_driver, execute_write, etc.) ...
import json
from datetime import datetime, timezone
from flask import current_app, g
import logging

log = logging.getLogger(__name__) # Sử dụng logger chuẩn
