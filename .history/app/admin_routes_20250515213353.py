            ...
            for node_data_from_neo4j in nodes_page_data:
                ...
                if raw_screenshot_filename: # Chỉ cần tên file
                    try:
                        ...
                        filename=raw_screenshot_filename # CHỈ TÊN FILE
                    )
                    logger.info(f"API: Generated URL for app '{node_app_name}', file '{raw_screenshot_filename}': {node_render_data['screenshot_full_url']}")
