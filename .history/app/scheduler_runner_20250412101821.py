            ...
            for job_config in job_configs:
                ...
                try:
                    ...
                    scheduler.add_job(
                        ...
                        # Nếu hàm func cần app context, phải xử lý bên trong hàm đó
                        # Hoặc nếu dùng ProcessPoolExecutor, func và args phải pickleable
                        # args=[app] # Có thể truyền app vào đây nếu executor là ThreadPool
                        name=f"Job for {func_name}" # Thêm tên cho dễ nhận biết
                    )
