...
def create_app(config_class=config.Config):
    ...
    from . import admin_routes # Import file chứa admin_bp
    app.register_blueprint(admin_routes.admin_bp) # Đăng ký blueprint

    from . import routes # Blueprint chính (nếu có)
    app.register_blueprint(routes.main_bp)

    from .phone import routes as phone_routes # Blueprint cho phone API
    app.register_blueprint(phone_routes.phone_bp)
    try:
